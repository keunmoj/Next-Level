...
import { StyledMyLearningComponent, StyledMyLearningTitle, StyledMyLearningButton } from './MyLearning.styled';
  ...
  return (
    <StyledMyLearningComponent>
      <StyledMyLearningTitle>
        <StyledMyLearningButton id="shadowing" onClick={(e: any) => handleState(e, 0)} state={myPageState}>
          {t('mypage.shadowing')}
        </StyledMyLearningButton>
        <StyledMyLearningButton id="sing" onClick={(e: any) => handleState(e, 1)} state={myPageState}>
          {t('mypage.sing')}
        </StyledMyLearningButton>
        <StyledMyLearningButton id="ai" onClick={(e: any) => handleState(e, 2)} state={myPageState}>
          {t('mypage.ai')}
        </StyledMyLearningButton>
      </StyledMyLearningTitle>
      <Swiper ref={swiperRef} modules={[Navigation]} onSlideChange={handleChange}>
        <SwiperSlide>
          <MyShadowing />
        </SwiperSlide>
        <SwiperSlide>
